...
CREATE TABLE `gallery_comment` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `galleryid` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `username` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `time` datetime NOT NULL
...
CREATE TABLE `gallery_paw` (
  ...
  `username` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `galleryid` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `commentid` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `time` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE `tag_gallery` (
  `id` int NOT NULL,
  `tagid` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `galleryid` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE `user` (
  ...
  `info` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `headimage` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `backimage` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_watch` (
  `id` int NOT NULL,
  `username` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `watcher` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `time` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
