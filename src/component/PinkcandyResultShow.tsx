...
function PlantpotShow(dataArray=[DefaultObj.plantpotdata]){
    const [showArray,setShowArray] = useState([DefaultObj.plantpotdata])
    const [pagenum,setPagenum] = useState(0)
    const [selectedPage,setSelectedPage] = useState(1)
    function updatePage(_event:any,value:number){setSelectedPage(value)}
    useEffect(()=>{
    ...
    return(
        <>
            <TabContext value={tabvalue}>
                ...
                <TabPanel value={'plantpot'}>{PlantpotShow(pinkcandyResult.plantpot)}</TabPanel>
